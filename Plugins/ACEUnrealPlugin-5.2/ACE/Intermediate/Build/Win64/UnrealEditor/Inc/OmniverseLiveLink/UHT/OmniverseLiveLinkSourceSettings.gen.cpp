...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::NewProp_AnimationDelayTime = { "AnimationDelayTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOmniverseLiveLinkSourceSettings, AnimationDelayTime), METADATA_PARAMS(Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::NewProp_AnimationDelayTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::NewProp_AnimationDelayTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::NewProp_AudioDelayTime = { "AudioDelayTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOmniverseLiveLinkSourceSettings, AudioDelayTime), METADATA_PARAMS(Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::NewProp_AudioDelayTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::NewProp_AudioDelayTime_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOmniverseLiveLinkSourceSettings_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID__stage_Plugins_ACE_HostProject_Plugins_OmniverseLiveLink_Source_OmniverseLiveLink_Public_OmniverseLiveLinkSourceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOmniverseLiveLinkSourceSettings, UOmniverseLiveLinkSourceSettings::StaticClass, TEXT("UOmniverseLiveLinkSourceSettings"), &Z_Registration_Info_UClass_UOmniverseLiveLinkSourceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOmniverseLiveLinkSourceSettings), 3254866398U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID__stage_Plugins_ACE_HostProject_Plugins_OmniverseLiveLink_Source_OmniverseLiveLink_Public_OmniverseLiveLinkSourceSettings_h_3337513702(TEXT("/Script/OmniverseLiveLink"),
